...
package ca.cgjennings.script.mozilla.classfile;

import java.io.IOException;
import java.io.InputStream;
import java.io.OutputStream;
import ca.cgjennings.script.mozilla.javascript.ObjArray;
import ca.cgjennings.script.mozilla.javascript.UintMap;
        ...
        try {
            ...
            if (is == null) {
                is = ClassLoader.getSystemResourceAsStream(
                    "ca/cgjennings/script/mozilla/classfile/ClassFileWriter.class");
            }
