...
public class Delegator implements Function {
     ...
     *
     * @see ca.cgjennings.script.mozilla.javascript.Delegator#construct
     */
    public Delegator() {
    }
    ...
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#getClassName
     */
    public String getClassName() {
        return obj.getClassName();
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#get(String, Scriptable)
     */
    public Object get(String name, Scriptable start) {
        return obj.get(name,start);
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#get(int, Scriptable)
     */
    ...
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#has(int, Scriptable)
     */
    ...
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#put(int, Scriptable, Object)
     */
    public void put(int index, Scriptable start, Object value) {
        obj.put(index,start,value);
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#delete(String)
     */
    public void delete(String name) {
        obj.delete(name);
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#delete(int)
     */
    public void delete(int index) {
        obj.delete(index);
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#getPrototype
     */
    public Scriptable getPrototype() {
        return obj.getPrototype();
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#setPrototype
     */
    public void setPrototype(Scriptable prototype) {
        obj.setPrototype(prototype);
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#getParentScope
     */
    public Scriptable getParentScope() {
        return obj.getParentScope();
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#setParentScope
     */
    public void setParentScope(Scriptable parent) {
        obj.setParentScope(parent);
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#getIds
     */
     ...
     *
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#getDefaultValue
     */
    ...
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#hasInstance
     */
    public boolean hasInstance(Scriptable instance) {
        return obj.hasInstance(instance);
    }
    /**
     * @see ca.cgjennings.script.mozilla.javascript.Function#call
     */
