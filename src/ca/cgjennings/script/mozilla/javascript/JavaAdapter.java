...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Lca/cgjennings/script/mozilla/javascript/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lca/cgjennings/script/mozilla/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lca/cgjennings/script/mozilla/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName, Constructor<?> superCtor)
    {
        ...
        if (parameters.length == 0) {
            cfw.startMethod("<init>",
                        ...
                        +"Lca/cgjennings/script/mozilla/javascript/ContextFactory;)V",
            ...
            StringBuilder sig = new StringBuilder(
                    "(Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                    +"Lca/cgjennings/script/mozilla/javascript/ContextFactory;");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ca/cgjennings/script/mozilla/javascript/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ca/cgjennings/script/mozilla/javascript/JavaAdapter",
                      "runScript",
                      "(Lca/cgjennings/script/mozilla/javascript/Script;"
                      +")Lca/cgjennings/script/mozilla/javascript/Scriptable;");
                                     ...
                                     boolean callConvertResult)
    {
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                          "ca/cgjennings/script/mozilla/javascript/Context",
