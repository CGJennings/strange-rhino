...
/**
 * Exception thrown by
 * {@link ca.cgjennings.script.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link ca.cgjennings.script.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link ca.cgjennings.script.mozilla.javascript.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link ca.cgjennings.script.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link ca.cgjennings.script.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link ca.cgjennings.script.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link ca.cgjennings.script.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
