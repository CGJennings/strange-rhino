...
package ca.cgjennings.script.mozilla.javascript.optimizer;

import ca.cgjennings.script.mozilla.javascript.*;
...
import ca.cgjennings.script.mozilla.classfile.*;

import java.util.*;
import java.lang.reflect.Constructor;

import static ca.cgjennings.script.mozilla.classfile.ClassFileWriter.ACC_FINAL;
import static ca.cgjennings.script.mozilla.classfile.ClassFileWriter.ACC_PRIVATE;
import static ca.cgjennings.script.mozilla.classfile.ClassFileWriter.ACC_PUBLIC;
import static ca.cgjennings.script.mozilla.classfile.ClassFileWriter.ACC_STATIC;
import static ca.cgjennings.script.mozilla.classfile.ClassFileWriter.ACC_VOLATILE;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "ca.cgjennings.script.mozilla.javascript.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("ca/cgjennings/script/mozilla/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "ca/cgjennings/script/mozilla/javascript/BaseFunction",
                      "createObject",
                      "(Lca/cgjennings/script/mozilla/javascript/Context;"
                      +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                      +")Lca/cgjennings/script/mozilla/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "ca/cgjennings/script/mozilla/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "ca/cgjennings/script/mozilla/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw, boolean isStrictMode)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ca/cgjennings/script/mozilla/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Lca/cgjennings/script/mozilla/javascript/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "ca/cgjennings/script/mozilla/javascript/ScriptRuntime",
                      "doTopCall",
                      "(Lca/cgjennings/script/mozilla/javascript/Callable;"
                      +"Lca/cgjennings/script/mozilla/javascript/Context;"
                      +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                      +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lca/cgjennings/script/mozilla/javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "ca/cgjennings/script/mozilla/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lca/cgjennings/script/mozilla/javascript/Context;"
                      +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                      +")V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lca/cgjennings/script/mozilla/javascript/Context;"
                      +")Lca/cgjennings/script/mozilla/javascript/RegExpProxy;");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "ca/cgjennings/script/mozilla/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lca/cgjennings/script/mozilla/javascript/Context;"
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "ca/cgjennings/script/mozilla/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "ca/cgjennings/script/mozilla/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptNode n)
    {
        ...
        sb.append("Lca/cgjennings/script/mozilla/javascript/Context;"
                  +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                  +"Lca/cgjennings/script/mozilla/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
    ...
    static final String REGEXP_INIT_METHOD_SIGNATURE
        =  "(Lca/cgjennings/script/mozilla/javascript/Context;)V";
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lca/cgjennings/script/mozilla/javascript/Scriptable;"
          +"Lca/cgjennings/script/mozilla/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
        ...
        if (fnCurrent != null)
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "ca/cgjennings/script/mozilla/javascript/Scriptable",
                          "getParentScope",
                          "()Lca/cgjennings/script/mozilla/javascript/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lca/cgjennings/script/mozilla/javascript/NativeFunction;"
                               +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +"Z"
                               +")Lca/cgjennings/script/mozilla/javascript/Scriptable;");
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lca/cgjennings/script/mozilla/javascript/NativeFunction;"
                               +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                               +"Lca/cgjennings/script/mozilla/javascript/Scriptable;II"
                               +")Lca/cgjennings/script/mozilla/javascript/Scriptable;");
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "ca/cgjennings/script/mozilla/javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lca/cgjennings/script/mozilla/javascript/Context;"
                    +")Lca/cgjennings/script/mozilla/javascript/Ref;");
                break;
    ...
    private void visitFunction(OptFunctionNode ofn, int functionType)
    {
        ...
        if (functionType == FunctionNode.ARROW_FUNCTION) {
            ...
            addOptRuntimeInvoke("bindThis",
                                ...
                                +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                                +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                                +")Lca/cgjennings/script/mozilla/javascript/Function;");
        }
    ...
    private void generateArrayLiteralFactory(Node node, int count) {
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Lca/cgjennings/script/mozilla/javascript/Context;"
                +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                +"[Ljava/lang/Object;"
                +")Lca/cgjennings/script/mozilla/javascript/Scriptable;",
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lca/cgjennings/script/mozilla/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                            +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lca/cgjennings/script/mozilla/javascript/Callable;"
                            +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                            +"Lca/cgjennings/script/mozilla/javascript/Context;"
                            +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "ca/cgjennings/script/mozilla/javascript/Callable",
                "call",
                "(Lca/cgjennings/script/mozilla/javascript/Context;"
                +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
                +"Lca/cgjennings/script/mozilla/javascript/Scriptable;"
    ...
    private String exceptionTypeToName(int exceptionType)
    {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "ca/cgjennings/script/mozilla/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "ca/cgjennings/script/mozilla/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "ca/cgjennings/script/mozilla/javascript/EcmaError";
