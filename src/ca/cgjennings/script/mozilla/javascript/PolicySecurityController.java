...
import ca.cgjennings.script.mozilla.classfile.ByteCode;
import ca.cgjennings.script.mozilla.classfile.ClassFileWriter;
...
public class PolicySecurityController extends SecurityController
{
    ...
    private static byte[] loadBytecode()
    {
        ...
        cfw.startMethod("call",
                "(Lca/cgjennings/script/mozilla/javascript/Callable;" + callableCallSig,
        ...
        cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "ca/cgjennings/script/mozilla/javascript/Callable", "call",
                "(" + callableCallSig);
