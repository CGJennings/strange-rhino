...
package ca.cgjennings.script.mozilla.javascript.tools;
...
public class ToolErrorReporter implements ErrorReporter {
     ...
     * ca.cgjennings.script.mozilla.javascript.tools.shell.resources.Messages property file.
    ...
    public static String getMessage(String messageId, Object[] args) {
        ...
        ResourceBundle rb = ResourceBundle.getBundle
            ("ca.cgjennings.script.mozilla.javascript.tools.resources.Messages", locale);
