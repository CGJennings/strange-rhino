...
import ca.cgjennings.script.mozilla.javascript.ContextAction;
import ca.cgjennings.script.mozilla.javascript.Function;
import ca.cgjennings.script.mozilla.javascript.GeneratedClassLoader;
import ca.cgjennings.script.mozilla.javascript.Kit;
...
import ca.cgjennings.script.mozilla.javascript.SecurityController;
import ca.cgjennings.script.mozilla.javascript.commonjs.module.ModuleScope;
import ca.cgjennings.script.mozilla.javascript.commonjs.module.Require;
import ca.cgjennings.script.mozilla.javascript.tools.SourceReader;
    ...
    private static void initJavaPolicySecuritySupport()
    {
        ...
        try {
            Class<?> cl = Class.forName
                ("ca.cgjennings.script.mozilla.javascript.tools.shell.JavaPolicySecurity");
