...
import ca.cgjennings.script.mozilla.javascript.v8dtoa.DoubleConversion;
import ca.cgjennings.script.mozilla.javascript.v8dtoa.FastDtoa;
import ca.cgjennings.script.mozilla.javascript.xml.XMLObject;
import ca.cgjennings.script.mozilla.javascript.xml.XMLLib;
...
public class ScriptRuntime {
    ...
    public final static Class<?>
        ContextClass
            = Kit.classOrNull("ca.cgjennings.script.mozilla.javascript.Context"),
        ContextFactoryClass
            = Kit.classOrNull("ca.cgjennings.script.mozilla.javascript.ContextFactory"),
        FunctionClass
            = Kit.classOrNull("ca.cgjennings.script.mozilla.javascript.Function"),
        ScriptableObjectClass
            = Kit.classOrNull("ca.cgjennings.script.mozilla.javascript.ScriptableObject");
                                                           ...
                                                           boolean sealed)
    {
        ...
        new LazilyLoadedCtor(scope, "RegExp",
                "ca.cgjennings.script.mozilla.javascript.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(scope, "Continuation",
                "ca.cgjennings.script.mozilla.javascript.NativeContinuation", sealed, true);
            ...
            (cx.getLanguageVersion() >= Context.VERSION_ES6))
        {
            new LazilyLoadedCtor(scope, "ArrayBuffer",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeArrayBuffer",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Int8Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeInt8Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Uint8Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeUint8Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Uint8ClampedArray",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeUint8ClampedArray",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Int16Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeInt16Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Uint16Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeUint16Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Int32Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeInt32Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Uint32Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeUint32Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Float32Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeFloat32Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "Float64Array",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeFloat64Array",
                                 sealed, true);
            new LazilyLoadedCtor(scope, "DataView",
                                 "ca.cgjennings.script.mozilla.javascript.typedarrays.NativeDataView",
                                 sealed, true);
        }
                                                       ...
                                                       boolean sealed)
    {
        ...
        new LazilyLoadedCtor(s, "Packages",
                "ca.cgjennings.script.mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(s, "getClass",
                "ca.cgjennings.script.mozilla.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(s, "JavaAdapter",
                "ca.cgjennings.script.mozilla.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(s, "JavaImporter",
                "ca.cgjennings.script.mozilla.javascript.ImporterTopLevel", sealed, true);
    ...
    public static ScriptableObject getGlobal(Context cx) {
        final String GLOBAL_CLASS = "ca.cgjennings.script.mozilla.javascript.tools.shell.Global";
