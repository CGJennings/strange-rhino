...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link ca.cgjennings.script.mozilla.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected ca.cgjennings.script.mozilla.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return ca.cgjennings.script.mozilla.javascript.xml.XMLLib.Factory.create(
                "ca.cgjennings.script.mozilla.javascript.xmlimpl.XMLLibImpl"
            );
        } else {
            return null;
        }
