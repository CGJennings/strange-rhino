...
public interface Scriptable {
     ...
     * <LI>ca.cgjennings.script.mozilla.javascript.Scriptable objects</LI>
     * <LI>null</LI>
     ...
     * @see ca.cgjennings.script.mozilla.javascript.Context#getUndefinedValue
     */
     ...
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see ca.cgjennings.script.mozilla.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see ca.cgjennings.script.mozilla.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see ca.cgjennings.script.mozilla.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see ca.cgjennings.script.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see ca.cgjennings.script.mozilla.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see ca.cgjennings.script.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see ca.cgjennings.script.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see ca.cgjennings.script.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see ca.cgjennings.script.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
