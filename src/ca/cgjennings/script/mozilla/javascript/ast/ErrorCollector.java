 ...
 * This a useful {@link ca.cgjennings.script.mozilla.javascript.ErrorReporter} when the
 * {@link ca.cgjennings.script.mozilla.javascript.CompilerEnvirons} is set to
 * ide-mode (for IDEs).
 *
 * @author Steve Yegge
 */
