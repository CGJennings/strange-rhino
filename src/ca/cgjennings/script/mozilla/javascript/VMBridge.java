...
public abstract class VMBridge
{
    ...
    {
        String[] classNames = {
            "ca.cgjennings.script.mozilla.javascript.VMBridge_custom",
            "ca.cgjennings.script.mozilla.javascript.jdk18.VMBridge_jdk18",
            "ca.cgjennings.script.mozilla.javascript.jdk15.VMBridge_jdk15",
        };
