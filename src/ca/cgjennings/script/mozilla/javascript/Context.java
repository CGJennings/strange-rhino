...
import ca.cgjennings.script.mozilla.javascript.debug.DebuggableScript;
import ca.cgjennings.script.mozilla.javascript.debug.Debugger;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(ca.cgjennings.script.mozilla.javascript.ContextFactory.Listener)
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "ca.cgjennings.script.mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "ca.cgjennings.script.mozilla.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(ca.cgjennings.script.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    @Deprecated
     ...
     *
     * @see ca.cgjennings.script.mozilla.javascript.ErrorReporter
     */
     ...
     * @see ca.cgjennings.script.mozilla.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (ca.cgjennings.script.mozilla.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see ca.cgjennings.script.mozilla.javascript.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "ca.cgjennings.script.mozilla.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "ca.cgjennings.script.mozilla.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "ca.cgjennings.script.mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
